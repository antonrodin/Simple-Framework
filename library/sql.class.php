<?php
	...
	*  @author: Justin Vincent (jv@jvmultimedia.com)
        *  @author: Slightly modified by Anton Zekeriev Rodin (www.azrodin.com)
	*  @link: http://twitter.com/justinvincent
	*  @name: Sql based on ezSQL
	*  @desc: mySQL component (part of sql databse abstraction library). Provide a fast access to the database.
	*/
	...
	*/
	...
	if ( ! class_exists ('Coresql') ) die('<b>Fatal Error:</b> SQL requires SQLcore (coresql.class.php) to be included/loaded before it can be used');

	class Sql extends Coresql {
