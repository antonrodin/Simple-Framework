<?php
	...
	/**
	*  @author: Based on ezSQL on Justin Vincent (jv@vip.ie)
        *  @author: Slightly modified by Anton Zekeriev Rodin (www.azrodin.com)
	*  @link: http://www.justinvincent.com
	*  @name: Coresql
	*  @desc: SQL core module - database abstraction library to make
	*          it very easy to deal with databases. Core sql can not be used by
